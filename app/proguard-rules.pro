...
# 将下面替换成自己的实体类
-keep class com.wangbin.mydome.bean.** { *; }
...
-keep class jxd.eim.receiver.MiPushReceiver {*;}
...
-dontwarn com.github.yuzhiqiang1993.**
-dontwarn com.yzq.zxinglibrary.**
-dontwarn com.yang.util.**

 #百度OCR
-keep class com.baidu.ocr.sdk.**{*;}
-dontwarn com.baidu.ocr.**
 #蓝牙
-keep class com.yang.util.** { *; }
-keep class com.yzq.zxinglibrary.** { *; }
-keep class com.github.yuzhiqiang1993.** { *; }